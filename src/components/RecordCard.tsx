...
// navigation morphs too. (The crate itself uses CrateRecord.) Wrapped in
// Reveal for scroll-entrance parity with CrateRecord — previously the only
// component in this pairing with zero scroll-driven motion.
  ...
  return (
    <Reveal delay={index * 0.08}>
      <Link href={`/work/${cs.slug}`} className="group block" data-record={cs.slug}>
        ...
        <h3 className="mt-1 text-[length:var(--step-h3)] font-display font-semibold tracking-tight">
          {cs.title}
        </h3>
